...
CLI.prototype.do_images = function do_images(subcmd, opts, args, callback) {
    var self = this;
...
CLI.prototype.do_images.description = (
    'List images.\n' +
    '\n' +
    'Usage:\n' +
    '    $NAME images [OPTIONS]\n' +
...
CLI.prototype.do_images.longOpts = {
    'json': Boolean,
    'skipHeader': Boolean,
    'output': String,
    'sort': String
};
CLI.prototype.do_images.shortOpts = {
    'j': ['--json'],
    'H': ['--skipHeader'],
    'o': ['--output'],
    's': ['--sort']
